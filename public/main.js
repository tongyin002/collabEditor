...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(0), __webpack_require__(5), __webpack_require__(16));
  else {}
})(function(CodeMirror) {
"use strict";
...
const Renderer = __webpack_require__(3);
const { defaults } = __webpack_require__(2);
...
var CodeMirrorSpellChecker = __webpack_require__(21);
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(0), __webpack_require__(4), __webpack_require__(6));
  else {}
})(function(CodeMirror) {
"use strict";
...
// Requires
var Typo = __webpack_require__(22);
...
const Parser = __webpack_require__(26);
const Renderer = __webpack_require__(3);
...
var easymde = __webpack_require__(11);
...
class editor_Editor {
  constructor(controller, elementId) {
    this.canvas = new easymde_default.a({
...
// CONCATENATED MODULE: ./src/char.js
/**
 * 
 */
class char_Char {
...
// CONCATENATED MODULE: ./src/crdt.js
...
// CONCATENATED MODULE: ./src/broadcast_service.js
...
let controller0 = new src_controller(
  location.origin,
...
let controller1 = new src_controller(
  location.origin,
  location.search.slice(1) || "0",
  "editor2",
  broadcastService
